<template lang="html">
  ...
  <div class="back" @click="$router.go(-1)">
    ...
    <div class="wring-top1">
      <ul class="wring-top1-ul">
        <li class="wring-top1-li" v-for="(val,k) in product" :key="val.cover" v-if="k<3">
          <a @click="gobuy(val)">
          <img class="top1-li-img" v-lazy="$helper.getRealPicURL(val.cover,val.company_id,val.shop_id,'w100_h100')"/>
          </a>
        </li>
      </ul>
    </div>
    ...
    <div class="wring-top3" v-for="(val,k) in product" :key="val.cover" v-if="k<6 &&k>2">
      ...
      <img v-lazy="$helper.getRealPicURL(val.cover,val.company_id,val.shop_id,'w100_h100')"/>
       </a>
    ...
    <ul class="wring-ul1">
      <li class="wring-ul1-li" v-for="(val,k) in product" :key="val.conver" v-if="k<12 &&k>6">
        <a @click="gobuy(val)">
        <img class="ul1-li-img" v-lazy="$helper.getRealPicURL(val.cover,val.company_id,val.shop_id,'w100_h100')"/>
        </a>
