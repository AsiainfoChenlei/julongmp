  ...
  <div class="back" @click="$router.go(-1)">
    ...
    <div class="bags-top2">
      ...
      <div class="bags-top2-content">
        ...
        <ul class="bags-top2-ul">
          <li class="bags-top2-li" v-for="(val,k) in product" v-if="k<12">
            <div class="top2-li-title">直降{{val.disprice}}元</div>
            <a @click="gobuy(val)">
            <img class="top2-li-img" v-lazy="$helper.getRealPicURL(val.cover,val.company_id,val.shop_id,'w100_h100')"/>
    ...
    <div class="bags-top3">
      ...
      <ul class="bags-top3-ul">
        <li class="bags-top3-li" v-for="(val,k) in product" v-if="k>12">
          <a @click="gobuy(val)">
          <img class="top3-li-img" v-lazy="$helper.getRealPicURL(val.cover,val.company_id,val.shop_id,'w100_h100')"/>
          </a>
