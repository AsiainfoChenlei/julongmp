  ...
  <div class="sheader" :style="headerBackGround">
    ...
    <div class="mint-content">
      <div class="mint-area1">
        ...
        <img class="area1-img" v-lazy="$helper.getRealPicURL(shopinfo.face,1,1,'w100_h100')" @click="headerimg"/>
        <div v-show="showimg" class="headerimg" @click="hihide">
          <img v-lazy="$helper.getRealPicURL(shopinfo.face,1,1,'w100_h100')"/>
        </div>
