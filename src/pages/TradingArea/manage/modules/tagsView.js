const tagsView = {
  ...
  mutations: {
    ADD_VISITED_VIEWS: (state, view) => {
      console.log('state.visitedViews_TREAD_NONONONONONONONONONONONONONONONONONADD_VISITED_VIEWS', state.visitedViews)
    ...
    ADD_VISITED_VIEWS6: (state, view) => {
      console.log('state.visitedViews_TREAD6_NONONONONONONONONONONONONONONONONONADD_VISITED_VIEWS666', state.visitedViews)
