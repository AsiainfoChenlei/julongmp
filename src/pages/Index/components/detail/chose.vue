<template lang="html">
  ...
  <!--  <div class="chose-mychosed" ontouchstart="">
    ...
    <div class="chose-pay">
      <span class="cp-color">价格：<span v-if="property.length > 0" class="cp-number" style="color: #f74b27">￥{{view.min_price}}</span>
                                   <span v-if="property.length > 0 &&  parseInt(view.max_price)>parseInt(view.min_price)" class="cp-number" style="color: #f74b27">—{{view.max_price}}</span></span>
     </div>
    <div class="chose-pay">
        <span class="cp-color" style="text-decoration:line-through;">实体店内零售价：<span v-if="property.length > 0" class="cp-number">￥{{property[0].offline_price}}</span></span>
    </div>
    <div class="chose-pay">
        <span class="cp-color">运费：<span v-if="property.length > 0" class="cp-number">￥{{property[0].freight}}</span></span>
    </div>
  </section>
</template>
