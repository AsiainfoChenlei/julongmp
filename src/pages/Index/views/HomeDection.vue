<template lang="html">
  ...
  <div class="back" @click="$router.go(-1)">
    ...
    <img class="hd-img" src="/static/images/banner01_01.jpg"/>
    <div class="hd-main">
      <ul class="hd-main-ul">
      ...
      <div class="hd-main-top1" v-for="(val,index) in product" :key="val.id" v-if="index<2">
        <a @click="gobuy(val)">
        <img class="hd-top1-img" v-lazy="$helper.getRealPicURL(val.cover,val.company_id,val.shop_id,'wfellow_h410')"/>
        </a>
        <div class="hd-top1-span">
          <h1 class="hd-top1-h1">{{val.title}}</h1>
          <p class="hd-top1-p">分类：{{val.category_name}}</p>
      ...
      <ul class="hd-main-ul2">
        <li class="hd-li2" v-for="(val,index) in product" :key="val.id" v-if="index<6 && index>1">
          <a @click="gobuy(val)">
          <img class="hd-li2-img" v-lazy="$helper.getRealPicURL(val.cover,val.company_id,val.shop_id,'wfellow_h410')"/>
          </a>
      ...
      <div class="hd-main-top3">
        ...
        <div class="hd-top3-part2">
          <img class="top3-part2-img" v-lazy="$helper.getRealPicURL(product[6].cover,product[6].company_id,product[6].shop_id,'wfellow_h410')"/>
      ...
      <div class="hd-main-top3">
        ...
        <div class="hd-top3-part2  hd-top4-part2">
          <img class="top3-part2-img" v-lazy="$helper.getRealPicURL(product[7].cover,product[7].company_id,product[7].shop_id,'wfellow_h410')"/>
          <div class="top3-part2-span">
      ...
      <div class="hd-main-top3">
        ...
        <div class="hd-top3-part2">
          <img class="top3-part2-img" v-lazy="$helper.getRealPicURL(product[8].cover,product[8].company_id,product[8].shop_id,'wfellow_h410')"/>
          <div class="top3-part2-span">
      ...
      <div class="hd-main-top5">
        ...
        <img class="hd-li2-img1" v-lazy="$helper.getRealPicURL(product[9].cover,product[9].company_id,product[9].shop_id,'wfellow_h410')"/>
        </a>
        <ul class="hd-main-ul2">
